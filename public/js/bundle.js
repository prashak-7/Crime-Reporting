    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Your registration was successfull");
            window.setTimeout(function () {
...
// Sort
var sortBy = document.querySelector("#sort-type-one");
var sortBasedOn = document.querySelector("#sort-type-two");
var sortForm = document.querySelector(".form-sort");
...
if (sortBy) {
  ...
  function handleDateDropDown(e) {
    ...
    if (curValue === "crimeDate") {
      sortBasedOn.innerHTML = "";
      var dateOption = ["Today", "One week ago", "One month ago", "One year ago"];
...
if (sortForm) {
  sortForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var sortOne = sortBy.value;
    var sortTwo = sortBasedOn.value;
    (0, _sortComplaint.sortComplaint)(sortOne, sortTwo);
  });
}
},{"./login":"login.js","./updateUser":"updateUser.js","./complaint":"complaint.js","./admin":"admin.js","./deleteUser":"deleteUser.js","./sortComplaint":"sortComplaint.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
